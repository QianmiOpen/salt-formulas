...
then
    ...
    ZOOMAIN="-Dcom.sun.management.jmxremote.port=1911 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false org.apache.zookeeper.server.quorum.QuorumPeerMain"
else
...
SERVER_JVMFLAGS="-Xms512m -Xmx4096m"
